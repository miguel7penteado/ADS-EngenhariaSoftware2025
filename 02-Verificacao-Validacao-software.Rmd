...
A *Verificação e Validação de Software* é uma grande revisão de finalização que é aplicada em todas as fases do desenvolvimento do software.
...
+---------------------------------------------+------------------------------------------------+-------------+
| -   revisões técnicas;                      | -   **teste de desenvolvimento;** \| \|        |             |
|                                             | -   **teste de usabilidade;** \| \|            |             |
| -   auditorias de qualidade e configuração; | -   **teste de qualificação;** \| \|           |             |
|                                             | -   **teste de aceitação; e** \| \|            |             |
| -   monitoramento de desempenho;            | -   **teste de instalação**. \| \| \| \| \| \| |             |
|                                             |                                                |             |
| -   simulação;                              |                                                |             |
|                                             |                                                |             |
...
| a) Revisões Técnicas                    |                                                                                                 |
+-----------------------------------------+-------------------------------------------------------------------------------------------------+
| b) Inspeções                            | Tipo específico de revisão formal onde uma pequena equipe fica o tempo todo revisando o código. |
+-----------------------------------------+-------------------------------------------------------------------------------------------------+
| c) Análise Estática                     |                                                                                                 |
+-----------------------------------------+-------------------------------------------------------------------------------------------------+
