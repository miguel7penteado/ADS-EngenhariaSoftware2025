...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0828}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.6561}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
...
\bottomrule\noalign{}
\endlastfoot
Pytest & Python & \begin{minipage}[t]{\linewidth}\raggedright
\begin{center}
...
\end{center}
\end{minipage} \\
JUnit & Java & \begin{minipage}[t]{\linewidth}\raggedright
\begin{center}
...
\end{center}
\end{minipage} \\
CTest & C++ & \begin{minipage}[t]{\linewidth}\raggedright
\begin{center}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 0\tabcolsep) * \real{1.0040}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
